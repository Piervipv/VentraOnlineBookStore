...
function fillPage(doc) {
    updateOrientationInfo(doc.theme);
...
function updateOrientationInfo(theme_title){
  $('#orientation-info').append(`
    <li class="breadcrumb-item" aria-current="page">${theme_title}</li>`
  );
}
